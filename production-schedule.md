...
메뉴를 열면 오늘이 포함된 주부터 3주(일요일~토요일, 총 21일)를 표시합니다. 이전 주·다음 주 버튼이나 기준일 선택으로 조회 범위를 옮기고, 오늘 기준 버튼으로 현재 기간으로 돌아갑니다. 월·연도가 바뀌어도 날짜와 일정은 이어서 표시하며 합계는 표시된 3주를 기준으로 계산합니다.
